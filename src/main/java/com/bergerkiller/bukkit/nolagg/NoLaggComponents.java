...
public enum NoLaggComponents {
    CHUNKS("Chunks", "Manages chunk loading and sending to clients using various new settings, also fixes chunk unload problems", false),
    ...
    NoLaggComponents(String name, String description) {
        this(name, description, true);
    }

    NoLaggComponents(String name, String description, boolean enabledByDefault) {
        this(name, "com.bergerkiller.bukkit.nolagg." + name.toLowerCase() + ".NoLagg" + name, description, enabledByDefault);
    }

    NoLaggComponents(String name, String mainclass, String description, boolean enabledByDefault) {
        this.enabled = false;
        this.name = name;
